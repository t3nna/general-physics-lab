...
\begin{table}[!ht]
    ...
    \hline
       No & $\phi_{in}$ $[mm]$&$\Delta{\phi_{in}}$ & $\phi_{out}$ $[mm]$& $\Delta{\phi_{out}}$ \\ \hline
        ...
        $\bar{V}$ $[mm^3]$& 2851.487655 & ~ & ~ & ~ \\ \hline
        $\rho$ $[g/cm^3]$ & 2.781705888 & ~ & ~ & ~ \\ \hline
        $u_{ˆ†c}$ ($\bar{V}$) & 431.2854846& ~ & ~ & ~  \\ \hline
        $u_c (\bar\rho)$  & 0.0004210374579& ~ & ~ & ~  \\ \hline
...
\begin{equation}
	u_{A+B}(\phi_{in}) = \sqrt{u_A^2(\bar\phi_{in})+u_B^2(\bar\phi_{o})}
	=\sqrt{0.00075^2+0.3441007604^2}=\SI{0.3441015778}{\mm}
\end{equation}
...
\begin{table}[H]
    ...
    \hline
        ...
        $u_{ˆ†c}$ ($\bar{V}$) & 224.7720491& ~ & ~ & ~  \\ \hline
        $u_c (\bar\rho)$  & 0.0002070566501& ~ & ~ & ~  \\ \hline
